...
const Gallery = () => {
    return (
        <div>
            <div className="bg-purple-100 flex font-roboto text-5xl justify-evenly items-center">
              
                <p data-aos="fade-left"
                    data-aos-offset="300"
                    data-aos-easing="ease-in-sine" className="w-[500px] font-lora">The best thing to hold onto in life is each other.</p>
