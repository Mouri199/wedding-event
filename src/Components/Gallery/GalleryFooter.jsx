...
const GalleryFooter = () => {
    return (
        <div>
            ...
            <div className="relative lg:flex justify-center gap-5 mt-32">
                <div data-aos="fade-up"
                    data-aos-duration="3000" className="lg:w-[500px] mx-5 bg-purple-100 h-[250px] lg:h-[300px] text-center">
                ...
                <div data-aos="fade-down"
                    ...
                    data-aos-duration="1500" className="lg:w-[500px] mx-5 bg-purple-100 h-[250px] lg:h-[300px] text-center">
